class ArithmeticOperations:
    ...
    def add(self, MemoryRegister, Accumulator, index):
    ...
    def subtract(self, MemoryRegister, Accumulator, index):
    ...
    def divide(self, MemoryRegister, Accumulator, index):
        accumVal = Accumulator.getAccum()
        memVal = MemoryRegister.getItemFromMemoryRegister(index)
        accumVal /= memVal
    ...
    def multiply(self, MemoryRegister, Accumulator, index):
        accumVal = Accumulator.getAccum()
        memVal = MemoryRegister.getItemFromMemoryRegister(index)
        accumVal *= memVal
        Accumulator.setAccum(accumVal)
